...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">FUENTE DE SODA</h1>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/4.webp" alt="Slider de la categoria">
            </figure>
        </div>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('FUENTE DE SODA')?>"><button class="cotizar">Cotizar</button></a>
