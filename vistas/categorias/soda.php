...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h2 class="categoria1__titulo ">FUENTE DE SODA</h2>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/1.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/2.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/3.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/FUENTE DE SODA/4.webp" alt="">
            </figure>
        </div>
