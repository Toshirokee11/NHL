...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">FAST FOOD</h1>
      
        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/FAST FOOD/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FAST FOOD/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FAST FOOD/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/FAST FOOD/4.webp" alt="Slider de la categoria">
            </figure>
        </div>
...
<br>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('FAST FOOD')?>"><button class="cotizar">Cotizar</button></a>
