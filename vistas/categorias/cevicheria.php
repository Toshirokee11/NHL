...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">CEVICHERÍA</h1>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/CEVICHERIA/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/CEVICHERIA/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/CEVICHERIA/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/CEVICHERIA/4.webp" alt="Slider de la categoria">
            </figure>
        </div>
...
<br>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('CEVICHERÍA')?>"><button class="cotizar">Cotizar</button></a>
...
<input type="hidden" id="url" class="hiden" value="https://www.flipsnack.com/alonsoddt/cevicheri-a-catalogo-con-textos.html">
