...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">ESTILO INDUSTRIAL</h1>

        <?php require_once "../layout/modal.php" ?>

        <!--<div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/INDUSTRIAL/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/INDUSTRIAL/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/INDUSTRIAL/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/INDUSTRIAL/4.webp" alt="Slider de la categoria">
            </figure>
        </div>-->
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('ESTILO INDUSTRIAL')?>"><button class="cotizar">Cotizar</button></a>
