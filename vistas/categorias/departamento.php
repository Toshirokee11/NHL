...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h2 class="categoria1__titulo ">DEPARTAMENTO</h2>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/DEPARTAMENTO/1.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DEPARTAMENTO/2.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DEPARTAMENTO/3.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DEPARTAMENTO/4.webp" alt="">
            </figure>
        </div>
        ...
        <div class="galeria-imagenes" id="departamento-imagen"></div>
