...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">BAR</h1>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/BAR/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/BAR/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/BAR/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/BAR/4.webp" alt="Slider de la categoria">
            </figure>
        </div>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('BAR')?>"><button class="cotizar">Cotizar</button></a>
