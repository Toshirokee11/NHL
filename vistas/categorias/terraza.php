...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h2 class="categoria1__titulo ">TERRAZA</h2>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/TERRAZA/1.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/TERRAZA/2.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/TERRAZA/3.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/TERRAZA/4.webp" alt="">
            </figure>
        </div>
        ...
        <div class="galeria-imagenes" id="terraza-imagen"></div>
