...
<?php require_once "../layout/header.php" ?>
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">SALÓN SPA Y BARBERÍA</h1>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('SALÓN SPA Y BARBERÍA')?>"><button class="cotizar">Cotizar</button></a>
