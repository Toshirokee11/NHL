...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">DORMITORIO PARA NIÑOS</h1>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('DORMITORIO PARA NIÑOS')?>"><button class="cotizar">Cotizar</button></a>
