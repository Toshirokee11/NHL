...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h2 class="categoria1__titulo ">DORMITORIO PARA NIÑOS</h2>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/DORMITORIO/1.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DORMITORIO/2.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DORMITORIO/3.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/DORMITORIO/4.webp" alt="">
            </figure>
        </div>
        ...
        <div class="galeria-imagenes" id="dormitorio-imagen"></div>
