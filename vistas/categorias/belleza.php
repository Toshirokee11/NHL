...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo ">SALÓN DE BELLEZA Y BARBERÍA</h1>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/1.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/2.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/3.webp" alt="Slider de la categoria">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/4.webp" alt="Slider de la categoria">
            </figure>
        </div>
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('SALÓN DE BELLEZA Y BARBERÍA')?>"><button class="cotizar">Cotizar</button></a>
