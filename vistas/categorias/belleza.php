...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        <h2 class="categoria1__titulo ">SALÓN DE BELLEZA Y BARBERÍA</h2>

        <?php require_once "../layout/modal.php" ?>

        <div id="slider">
            <figure>
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/1.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/2.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/3.webp" alt="">
                <img loading="lazy" src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/4.webp" alt="">
            </figure>
        </div>
