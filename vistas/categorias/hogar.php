...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <a href="../contacto.php?v=<?php echo base64_encode('HOGAR')?>"><button class="cotizar">Cotizar</button></a>
        ...
        <div id="form_1" class="overlay__formulario">
            ...
            <form class="overlay__form" id="restaurante">
                ...
                <input type="hidden" id="nomcategory" class="hiden" value="hogar">
                <input type="hidden" id="url" class="hiden" value="https://www.flipsnack.com/nhlweb/hogar-catalogo-con-textos.html">
                <input type="submit" class="overlay__submit" value="Obtener mi catálogo de categoría Hogar">
